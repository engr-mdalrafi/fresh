      ...
      <section id="best_fashion" className='pb-24 pt-32'>
        <div className="container relative">
          <div className='sm:hidden md:hidden lg:block'>
            ...
            <div className='sm:grid grid-cols-1 sm: lg:grid lg:grid-cols-2 lg:gap-32'>
                <div className='sm:w-10/12 lg:w-full'>
                    <img src="/fashion_since.png" alt="fashion_since" className='w-full' />
                </div>
                <div className="sm:text-center lg:w-md  text-black font-popins">
                    ...
                    <div className="sm:hidden md:hidden lg:block counter">
